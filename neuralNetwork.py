...
class neuralNetwork:
    def __init__(self, inputNodes, hiddenNodes, outputNodes, learningRate):
        ...
        # self.wih = numpy.random.rand( self.iNodes,self.hNodes).T - 0.5
        # self.who = numpy.random.rand( self.hNodes,self.oNodes).T - 0.5
...
print(n.query((numpy.asarray(all_values[1:],dtype=numpy.float64)/ 255.0 * 0.99)+0.01).argmax())
